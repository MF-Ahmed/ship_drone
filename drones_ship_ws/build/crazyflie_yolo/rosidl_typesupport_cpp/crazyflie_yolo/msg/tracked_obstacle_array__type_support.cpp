...
static const _TrackedObstacleArray_type_support_symbol_names_t _TrackedObstacleArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crazyflie_yolo, msg, TrackedObstacleArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, crazyflie_yolo, msg, TrackedObstacleArray)),
  }
};
...
{
  return &::crazyflie_yolo::msg::rosidl_typesupport_cpp::TrackedObstacleArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, crazyflie_yolo, msg, TrackedObstacleArray)() {
  return get_message_type_support_handle<crazyflie_yolo::msg::TrackedObstacleArray>();
}
