...
#include "crazyflie_yolo/msg/detail/tracked_obstacle__rosidl_typesupport_fastrtps_c.h"
...
using _TrackedObstacle__ros_msg_type = crazyflie_yolo__msg__TrackedObstacle;
...
size_t get_serialized_size_crazyflie_yolo__msg__TrackedObstacle(
  ...
  size_t current_alignment)
{
  const _TrackedObstacle__ros_msg_type * ros_message = static_cast<const _TrackedObstacle__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crazyflie_yolo__msg__TrackedObstacle;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const crazyflie_yolo__msg__TrackedObstacle * ros_message = static_cast<const crazyflie_yolo__msg__TrackedObstacle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_crazyflie_yolo__msg__TrackedObstacle(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  crazyflie_yolo__msg__TrackedObstacle * ros_message = static_cast<crazyflie_yolo__msg__TrackedObstacle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_crazyflie_yolo__msg__TrackedObstacle(cdr, ros_message);
}

static uint32_t _TrackedObstacle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_crazyflie_yolo__msg__TrackedObstacle(
...
static size_t _TrackedObstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_crazyflie_yolo__msg__TrackedObstacle(
...
static message_type_support_callbacks_t __callbacks_TrackedObstacle = {
  "crazyflie_yolo::msg",
  "TrackedObstacle",
...
static rosidl_message_type_support_t _TrackedObstacle__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrackedObstacle,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crazyflie_yolo, msg, TrackedObstacle)() {
  return &_TrackedObstacle__type_support;
}
