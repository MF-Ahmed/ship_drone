...
#include "crazyflie_yolo/msg/detail/tracked_obstacle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const crazyflie_yolo::msg::TrackedObstacle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  crazyflie_yolo::msg::TrackedObstacle & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crazyflie_yolo::msg::TrackedObstacle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const crazyflie_yolo::msg::TrackedObstacle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<crazyflie_yolo::msg::TrackedObstacle *>(
    untyped_ros_message);
...
{
  return &crazyflie_yolo::msg::typesupport_fastrtps_cpp::_TrackedObstacle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crazyflie_yolo, msg, TrackedObstacle)() {
  return &crazyflie_yolo::msg::typesupport_fastrtps_cpp::_TrackedObstacle__handle;
}
