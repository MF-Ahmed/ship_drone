...
: ${AMENT_CURRENT_PREFIX:="/home/user/data/drones_ship_ws/install/aquabot_motion"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/aquabot_motion/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/aquabot_motion/environment/path.sh"
