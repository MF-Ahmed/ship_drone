...
: ${AMENT_CURRENT_PREFIX:="/home/user/data/drones_ship_ws/install/crazyflie_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/crazyflie_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/crazyflie_control/environment/path.sh"
