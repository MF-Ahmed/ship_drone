...
bool crazyflie_yolo__msg__tracked_obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("crazyflie_yolo.msg._tracked_obstacle.TrackedObstacle", full_classname_dest, 52) == 0);
  }
  crazyflie_yolo__msg__TrackedObstacle * ros_message = _ros_message;
  {  // header
...
PyObject * crazyflie_yolo__msg__tracked_obstacle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("crazyflie_yolo.msg._tracked_obstacle");
