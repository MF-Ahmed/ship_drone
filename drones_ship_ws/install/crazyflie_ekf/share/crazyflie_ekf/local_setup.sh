...
: ${AMENT_CURRENT_PREFIX:="/home/user/data/drones_ship_ws/install/crazyflie_ekf"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/crazyflie_ekf/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/crazyflie_ekf/environment/path.sh"
