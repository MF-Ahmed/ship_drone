...
fusion_csv = with_ts("/home/user/data/drones_ship_ws/src/drone_ship/crazyflie_yolo/logs_fusion/2nd/Path2_fused_obstacles.csv", ts)
assign_csv = with_ts("/home/user/data/drones_ship_ws/src/drone_ship/crazyflie_yolo/logs_assignment/2nd/Path2_assignment_log.csv", ts)

event_log_path = with_ts("/home/user/data/drones_ship_ws/src/drone_ship/crazyflie_yolo/logs_fusion/2nd/Path2_fusion_events.csv", ts)
prune_log_path = with_ts("/home/user/data/drones_ship_ws/src/drone_ship/crazyflie_yolo/logs_fusion/2nd/Path2_prune_events.csv", ts)
stats_log_path = with_ts("/home/user/data/drones_ship_ws/src/drone_ship/crazyflie_yolo/logs_fusion/2nd/Path2_fusion_stats.csv", ts)
...
ros2_move_drone1_cmd = "ros2 run crazyflie_servers dual_action_client --ros-args \
  ...
  -p distance_x:=20.0 -p distance_y:=0.0 -p speed:=0.20"
