...
def launch_setup():
    ...
    sdf_file = '/home/user/data/ros2_ws/src/drone_ship/aquabot_gz/models/crazyflie/gazebo/crazyflie/model.sdf'
    ...
    with sl.group(ns = 'aquabot'):
        ...
        with sl.group(ns='crazyflie'):
            ...
            sl.node(
                ...
                arguments=[
                    '-name', 'crazyflie',
                    '-x', '1', '-y', '0', '-z', '3',  # moved far and higher
                    '-file', sdf_file
                ],
                output='screen'
            )    
